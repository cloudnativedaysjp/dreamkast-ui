...
export const EventApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1EventsGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const EventApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1EventsGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Event>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1EventsGet(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const EventApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiV1EventsGet(options?: any): AxiosPromise<Array<Event>> {
            return localVarFp.apiV1EventsGet(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class EventApi extends BaseAPI {
     ...
     * @memberof EventApi
     */
    public apiV1EventsGet(options?: AxiosRequestConfig) {
        return EventApiFp(this.configuration).apiV1EventsGet(options).then((request) => request(this.axios, this.basePath));
    }
}
