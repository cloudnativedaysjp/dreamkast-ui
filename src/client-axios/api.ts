 ...
 * @export
 */
export const BoothApiAxiosParamCreator = function (
...
export const BoothApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV1BoothsBoothIdGet(
      boothId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Booth>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1BoothsBoothIdGet(boothId, options)
 ...
 * @export
 */
export const BoothApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    apiV1BoothsBoothIdGet(boothId: string, options?: any): AxiosPromise<Booth> {
      return localVarFp
        .apiV1BoothsBoothIdGet(boothId, options)
...
export class BoothApi extends BaseAPI {
  ...
  public apiV1BoothsBoothIdGet(boothId: string, options?: AxiosRequestConfig) {
    return BoothApiFp(this.configuration)
      .apiV1BoothsBoothIdGet(boothId, options)
...
export const ChatMessageApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1ChatMessagesMessageIdPut: async (
      messageId: string,
      ...
      const localVarPath = `/api/v1/chat_messages/{messageId}`.replace(
        `{${'messageId'}}`,
...
export const ChatMessageApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1ChatMessagesGet(
          eventAbbr,
          roomId,
          roomType,
          createdFrom,
     ...
     * @throws {RequiredError}
     */
    async apiV1ChatMessagesMessageIdPut(
      messageId: string,
      updateChatMessage?: UpdateChatMessage,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1ChatMessagesMessageIdPut(
          messageId,
          updateChatMessage,
          options,
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1ChatMessagesPost(
          chatMessage,
          options,
        )
      return createRequestFunction(
...
export const ChatMessageApiFactory = function (
  ...
  return {
    ...
    apiV1ChatMessagesGet(
      ...
      return localVarFp
        .apiV1ChatMessagesGet(eventAbbr, roomId, roomType, createdFrom, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiV1ChatMessagesMessageIdPut(
      ...
      return localVarFp
        .apiV1ChatMessagesMessageIdPut(messageId, updateChatMessage, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiV1ChatMessagesPost(
      ...
      return localVarFp
        .apiV1ChatMessagesPost(chatMessage, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ChatMessageApi extends BaseAPI {
   ...
   * @memberof ChatMessageApi
   */
  public apiV1ChatMessagesMessageIdPut(
    messageId: string,
    updateChatMessage?: UpdateChatMessage,
    options?: AxiosRequestConfig,
  ) {
...
export const EventApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1EventsEventAbbrGet: async (
      eventAbbr: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter '[eventAbbr]' is not null or undefined
      assertParamExists('apiV1EventsEventAbbrGet', 'eventAbbr', eventAbbr)
      const localVarPath = `/api/v1/events/{eventAbbr}`.replace(
        `{${'eventAbbr'}}`,
        encodeURIComponent(String(eventAbbr)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL)
      let baseOptions
...
export const EventApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1EventsEventAbbrGet(
          eventAbbr,
          options,
        )
      return createRequestFunction(
...
export const EventApiFactory = function (
  ...
  return {
    ...
    apiV1EventsEventAbbrGet(
      ...
      return localVarFp
        .apiV1EventsEventAbbrGet(eventAbbr, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class EventApi extends BaseAPI {
   ...
   * @memberof EventApi
   */
  public apiV1EventsEventAbbrGet(
    eventAbbr: string,
    options?: AxiosRequestConfig,
  ) {
...
export const ProfileApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1EventAbbrMyProfileGet: async (
      eventAbbr: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter '[eventAbbr]' is not null or undefined
      assertParamExists('apiV1EventAbbrMyProfileGet', 'eventAbbr', eventAbbr)
      const localVarPath = `/api/v1/${eventAbbr}/my_profile`.replace(
        `{${'eventAbbr'}}`,
        encodeURIComponent(String(eventAbbr)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProfileApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV1EventAbbrMyProfileGet(
      eventAbbr: string,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1EventAbbrMyProfileGet(
          eventAbbr,
          options,
        )
      return createRequestFunction(
...
export const ProfileApiFactory = function (
  ...
  return {
    ...
    apiV1EventAbbrMyProfileGet(
      ...
      return localVarFp
        .apiV1EventAbbrMyProfileGet(eventAbbr, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class ProfileApi extends BaseAPI {
   ...
   * @memberof ProfileApi
   */
  public apiV1EventAbbrMyProfileGet(
    eventAbbr: string,
    options?: AxiosRequestConfig,
  ) {
 ...
 * @export
 */
export const SponsorApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const SponsorApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV1SponsorsGet(
      eventAbbr: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Sponsor>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1SponsorsGet(eventAbbr, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const SponsorApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    apiV1SponsorsGet(
      eventAbbr: string,
      options?: any,
    ): AxiosPromise<Array<Sponsor>> {
      return localVarFp
        .apiV1SponsorsGet(eventAbbr, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class SponsorApi extends BaseAPI {
  ...
  public apiV1SponsorsGet(eventAbbr: string, options?: AxiosRequestConfig) {
    return SponsorApiFp(this.configuration)
      .apiV1SponsorsGet(eventAbbr, options)
      .then((request) => request(this.axios, this.basePath))
  }
}
 ...
 * @export
 */
export const TalkApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const TalkApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async apiV1TalksGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Talk>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1TalksGet(
        eventAbbr,
        trackId,
        conferenceDayIds,
        options,
     ...
     * @throws {RequiredError}
     */
    async apiV1TalksTalkIdGet(
      talkId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Talk>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1TalksTalkIdGet(talkId, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const TalkApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    apiV1TalksGet(
      ...
      conferenceDayIds?: string,
      options?: any,
    ): AxiosPromise<Array<Talk>> {
      return localVarFp
        .apiV1TalksGet(eventAbbr, trackId, conferenceDayIds, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiV1TalksTalkIdGet(talkId: string, options?: any): AxiosPromise<Talk> {
      return localVarFp
        .apiV1TalksTalkIdGet(talkId, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class TalkApi extends BaseAPI {
   ...
   * @memberof TalkApi
   */
  public apiV1TalksGet(
    eventAbbr: string,
    trackId?: string,
    conferenceDayIds?: string,
    options?: AxiosRequestConfig,
  ) {
    return TalkApiFp(this.configuration)
      .apiV1TalksGet(eventAbbr, trackId, conferenceDayIds, options)
      .then((request) => request(this.axios, this.basePath))
  }
...
export const TrackApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1TracksTrackIdViewerCountGet: async (
      trackId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'trackId' is not null or undefined
      assertParamExists('apiV1TracksTrackIdViewerCountGet', 'trackId', trackId)
      const localVarPath = `/api/v1/tracks/{trackId}/viewer_count`.replace(
        `{${'trackId'}}`,
        encodeURIComponent(String(trackId)),
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const TrackApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV1TracksGet(
      eventAbbr: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Track>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1TracksGet(
        eventAbbr,
        options,
      )
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiV1TracksTrackIdGet(
      trackId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Track>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1TracksTrackIdGet(trackId, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
     ...
     * @throws {RequiredError}
     */
    async apiV1TracksTrackIdViewerCountGet(
      trackId: string,
      options?: AxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ViewerCount>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiV1TracksTrackIdViewerCountGet(
          trackId,
          options,
        )
      return createRequestFunction(
...
export const TrackApiFactory = function (
  ...
  return {
    ...
    apiV1TracksGet(
      eventAbbr: string,
      options?: any,
    ): AxiosPromise<Array<Track>> {
      return localVarFp
        .apiV1TracksGet(eventAbbr, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiV1TracksTrackIdGet(trackId: string, options?: any): AxiosPromise<Track> {
      return localVarFp
        .apiV1TracksTrackIdGet(trackId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    apiV1TracksTrackIdViewerCountGet(
      trackId: string,
      options?: any,
    ): AxiosPromise<ViewerCount> {
      return localVarFp
        .apiV1TracksTrackIdViewerCountGet(trackId, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class TrackApi extends BaseAPI {
   ...
   * @memberof TrackApi
   */
  public apiV1TracksTrackIdViewerCountGet(
    trackId: string,
    options?: AxiosRequestConfig,
  ) {
    return TrackApiFp(this.configuration)
