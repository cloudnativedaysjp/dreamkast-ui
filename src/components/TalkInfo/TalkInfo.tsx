...
export const TalkInfo: React.FC<Props> = ({ selectedTalk, selectedTrackName }) => {
  ...
  return (
    ...
    <Styled.Container>
      ...
      <Styled.ShareButton href="https://discord.gg/bvuTMNQ" target="_blank">
        <Styled.SocialImg src="/cndo2021/ui/images/discord.png" /><Styled.SocialText>Ask the speaker</Styled.SocialText>
      </Styled.ShareButton>
      <Styled.ShareButton href={twitterURL(selectedTrackName)} target="_blank">
        <Styled.SocialImg src="/cndo2021/ui/images/twitter.png" /><Styled.SocialText>Twitterでつぶやく #CNDT2020_{selectedTrackName}</Styled.SocialText>
      </Styled.ShareButton>
    </Styled.Container>
  </Styled.OuterContainer>
  )
