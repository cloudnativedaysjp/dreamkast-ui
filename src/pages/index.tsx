  ...
  return (
    <Layout title="Home | Next.js + TypeScript Example">
      <Grid container spacing={0} justify="center" alignItems="center" alignContent="center">
        <Grid item xs={12} md={8} className={classes.debug} justify="center" alignItems="center" alignContent="center">
          <TrackSelector selectedTrackId={selectedTrackId} selectTrack={selectTrack} />
        </Grid>
